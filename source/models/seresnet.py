...
class SEResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,model_config=None):
        self.inplanes = 64
...
class SEResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, cardinality=32, num_classes=1000,model_config=None):
...
if __name__ =='__main__':
    model = se_resnet50(model_config=[2,3,4])
    print(model)